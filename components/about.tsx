        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="animate-slide-in-left">
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              ...
              <p className="text-pretty">
                Currently, I'm a Senior Architect at <span className="text-">Studio Arch</span>, specializing in
              ...
              <p className="text-pretty">
                ...
                <span className="text-foreground">cultural institutions</span>. Additionally, I also released a{" "}
                <span className="text-foreground">comprehensive design course</span> a few years ago, guiding learners
            ...
            <div className="space-y-8">
              <div className="github-card">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold">Senior Architect, Sustainability</h3>
                    <p>Studio Arch</p>
                  </div>
                  <span className="text-sm text-muted-foreground bg-muted px-2 py-1 rounded">2020 — Present</span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <span className="text-xs bg-accent/10 px-2 py-1 rounded-full">LEED</span>
                  <span className="text-xs bg-accent/10 px-2 py-1 rounded-full">Sustainable Design</span>
                  <span className="text-xs bg-accent/10 px-2 py-1 rounded-full">BIM</span>
                  <span className="text-xs bg-accent/10 px-2 py-1 rounded-full">Project Management</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat) => (
                  <div key={stat.label} className="github-card text-center">
