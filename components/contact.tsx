      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16">
            <ScrollReveal className="animate-slide-in-left" delay={200}>
              <div>
                ...
                <div className="space-y-6">
                  <div className="animate-fade-in-stagger">
                    ...
                    <p className="text-muted-foreground hover:text-blue-500 transition-colors duration-200">hello@marcuschen.design</p>
                  </div>

                  <div className="animate-fade-in-stagger animate-stagger-1">
                    <h4 className="font-semibold mb-2">Phone</h4>
                    <p className="text-muted-foreground hover:text-blue-500 transition-colors duration-200">+1 (555) 123-4567</p>
                  </div>

                  <div className="animate-fade-in-stagger animate-stagger-2">
                    <h4 className="font-semibold mb-2">Studio</h4>
                    <p className="text-muted-foreground hover:text-blue-500 transition-colors duration-200">
                      123 Design District
                      <br />
