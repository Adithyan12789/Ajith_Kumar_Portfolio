        ...
        <ScrollReveal>
          <div className="animate-slide-up">
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              {/* Brand Section */}
              <div className="md:col-span-2 animate-fade-in-stagger">
              ...
              <div className="animate-fade-in-stagger animate-stagger-1">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="#about" className="text-muted-foreground hover:text-blue-500 transition-colors duration-200 hover:translate-x-1 transform block">
                      About
                    </a>
                  </li>
                  <li>
                    <a href="#services" className="text-muted-foreground hover:text-blue-500 transition-colors duration-200 hover:translate-x-1 transform block">
                      Services
                    </a>
                  </li>
                  <li>
                    <a href="#projects" className="text-muted-foreground hover:text-blue-500 transition-colors duration-200 hover:translate-x-1 transform block">
                      Projects
                    </a>
                  </li>
                  <li>
                    <a href="#contact" className="text-muted-foreground hover:text-blue-500 transition-colors duration-200 hover:translate-x-1 transform block">
                      Contact
                    </a>
                  </li>
                </ul>
